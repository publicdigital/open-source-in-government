...
Furthermore, encouraging local companies and wider communities around open source software can create new markets and open up more options for governments in how they deliver services. One of the best examples of this is in the UK, where the Government Digital Service (GDS) built its new procurement framework around a philosophy of buying either teams to help build a service, or commodities that do not require customisation. This – coupled with the push from within GDS and other parts of the UK Government to use open source software, and code in the open – contributed to open source having an economic impact of ~£15bn on the UK economy[^23]. 
